...
const createWindow = (): void => {
  ...
  board.on("ready", () => {
    ...
    potentiometer.on("change", function () {
      ...
      mainWindow.webContents.send('update-position-x', (this.value/1000) * 2.0 -  3.0)
    });   

    let button = new five.Button(8);
    button.on("press", () => {
      console.log("button prssed")
      const yval = Math.round(Math.random() * 2);
      console.log(yval)
      mainWindow.webContents.send('update-position-y', yval)
    })
